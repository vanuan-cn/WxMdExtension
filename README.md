...
> 点击右下角 **M** 按钮打开 Markdown 编辑器，左侧编写、右侧实时预览，一键插入到公众号。

![使用演示](screenshots/demo.gif)

### 编辑器界面

![编辑器界面](screenshots/editor-interface.png)

### 插入效果

Markdown 内容一键插入公众号编辑器后的渲染效果：

![插入效果](screenshots/inserted-result.png)
